...
public class GeraMenu {
    public Menu menuModalidades(Aluno aluno) {// Menu principal de modalidades e submenus com suas atividades
        ...
        new ParecerDao().insertParecer(requerimento);// Cria um parecer para o requerimento
        List<Modalidade> modalidades = new ModalidadeDao().consultarModalidades(); // Consulta as modalidades disponíveis
        // Loop que cria as opções de menu para cada modalidade
        for (Modalidade modalidade : modalidades) {
            // Adiciona uma opção de menu para cada modalidade, com um submenu que contém as atividades complementares dessa modalidade
        ...
        // Adiciona a opção de finalizar o menu e emitir parecer
